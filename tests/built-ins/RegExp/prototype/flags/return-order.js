...
---*/
console.log(new RegExp("", "gimuy").flags);
assert.sameValue(new RegExp("", "gimuy").flags, "gimuy", "dgimsuy => dgimsuy");

console.log(new RegExp("", "yumig").flags);
assert.sameValue(new RegExp("", "yumig").flags, "gimuy", "yusmigd => dgimsuy");
